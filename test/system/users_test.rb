...
class UsersTest < ApplicationSystemTestCase
  test "new user can sign up" do
    ...
    assert_selector "p.is-danger", 
      text: I18n.t("activerecord.errors.models.user.attributes.password.too_short")+" and "+I18n.t("activerecord.errors.models.user.attributes.password.password_complexity")
    
    fill_in User.human_attribute_name(:password), with: "Password11"
    fill_in User.human_attribute_name(:password_confirmation), with: "Password11"
